...
public final class UIUtils {
    ...
    public static final String         IMAGE_LAYOUT_TRANSLATOR   = "translate.png";
    ...
    public static Font createFont(Control control, int style) {
        ...
        return UIUtils.createFont(control, style, 0);
    }
    ...
    public static Font createFont(int style) {
        return UIUtils.createFont(style, 0);
    }
    ...
    public static Color getSystemColor(int colorId) {
        return RBEPlugin.getDefault().getWorkbench().getDisplay().getSystemColor(colorId);
    }
    ...
    public static void showErrorDialog(Shell shell, CoreException exception, String msgKey) {
        ...
        ErrorDialog.openError(shell, RBEPlugin.getString(msgKey), exception.getLocalizedMessage(), exception.getStatus());
    }
    ...
    public static void showErrorDialog(Shell shell, Exception exception, String msgKey) {
        exception.printStackTrace();
        IStatus status = new Status(IStatus.ERROR, RBEPlugin.ID, 0, RBEPlugin.getString(msgKey) + " " + RBEPlugin.getString("error.seeLogs"), exception);
    ...
    public static Image getImage(String imageName) {
        Image image = UIUtils.imageRegistry.get(imageName);
        if (image == null) {
            image = RBEPlugin.getImageDescriptor(imageName).createImage();
            UIUtils.imageRegistry.put(imageName, image);
        }
        return image;
    }
}
